...
if ( class_exists( 'MeowPro_MWCODE_Core' ) && class_exists( 'Meow_MWCODE_Core' ) ) {
  ...
  {
    echo '<div class="error"><p>' . __( 'Thanks for installing the Pro version of Snippet Vault : ) However, the free version is still enabled. Please disable or uninstall it.', 'snippet-vault' ) . '</p></div>';
  }
